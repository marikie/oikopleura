...
Rscript "$r_scripts_path/logRatioPlot.R" "$org2tsv"
Rscript "$r_scripts_path/logRatioPlot.R" "$org3tsv"
...
Rscript "$r_scripts_path/logRatioPlot.R" "$org2tsv_maflinked"
Rscript "$r_scripts_path/logRatioPlot.R" "$org3tsv_maflinked"
