...
def convert2PlusStrand(coord, gLength, gStrand):
    if gStrand == "+":
        return coord
    else:
        oppCoord = gLength - coord
        return oppCoord


def write2TSV(aln, i, g1Tri, g2Tri, g3Tri, writer):
    gStart1 = convert2PlusStrand(aln.gStart1, aln.gLength1, aln.gStrand1)
    gStart2 = convert2PlusStrand(aln.gStart2, aln.gLength2, aln.gStrand2)
    gStart3 = convert2PlusStrand(aln.gStart3, aln.gLength3, aln.gStrand3)
    writer.writerow(
        [
            aln.gChr1,
            gStart1 + i,
