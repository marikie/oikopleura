...
# ---- embryos ----
if [ ! -e "embryos_te-te_fusions_1-base_$DATE.out" ]; then
        echo "embryos: getting TE-TE fusions (1-base)"
        python ~/oikopleura/analysis/get_TE_TE_splits_faster_1_base.py ~/data/last/OKI2018_I69.RepMask.out ~/data/last/embryos/lastsplitOKI2018_I69_1.0_whole_ERR4570985_filtered_trimmed_sorted_interleaved_postmask_removed.chrUn_onlysplits.maf ~/data/te-te-splits/embryos_te-te_fusions_1-base_$DATE
fi
...
# ---- immature adults -----
if [ ! -e "immatureAdults_te-te_fusions_1-base_$DATE.out" ]; then
        echo "immature adults: getting TE-TE fusions (1-base)"
        python ~/oikopleura/analysis/get_TE_TE_splits_faster_1_base.py ~/data/last/OKI2018_I69.RepMask.out ~/data/last/immatureAdults/lastsplitOKI2018_I69_1.0_whole_ERR4570986_filtered_trimmed_sorted_interleaved_postmask_removed.chrUn_onlysplits.maf ~/data/te-te-splits/immatureAdults_te-te_fusions_1-base_$DATE
fi
...
# ---- matured adults ----
if [ ! -e "maturedAdults_te-te_fusions_1-base_$DATE.out" ]; then
        echo "matured adults: getting TE-TE fusions (1-base)"
        python ~/oikopleura/analysis/get_TE_TE_splits_faster.py ~/data/last/OKI2018_I69.RepMask.out ~/data/last/immatureAdults/lastsplitOKI2018_I69_1.0_whole_ERR4570986_filtered_trimmed_sorted_interleaved_postmask_removed.chrUn_onlysplits.maf ~/data/te-te-splits/maturedAdults_te-te_fusions_1-base_$DATE
fi
