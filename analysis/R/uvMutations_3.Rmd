...
# CODE OF FROM https://github.com/kartong88/Plot-Mutation-Landscape

generate_plot<-function(mutlist, pct_yaxs_max = 5.5, filename=0, graphTitle){
  ...
  conv.data<-table(toupper(mutlist$mutation_type))
...
title <- "oikAlb-oikDio"
generate_plot(mutlist = data, pct_yaxs_max = 5.5, filename = paste0(title, ".pdf"), graphTitle=title)
