...
generate_plot<-function(mutlist, pct_yaxs_max = 5.5, filename=0){
  ...
  barplot(conv.data.norm[conv.label.all.sorted], col=rep(colour_array,each=16), cex.names=0.3, las=3, names.arg=trinuc.lab.sorted,ylim=c(0,pct_yaxs_max), ylab="Percentage of Mutations (%)", xlab="Trinucleotide")
