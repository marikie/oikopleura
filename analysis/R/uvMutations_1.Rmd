---
title: "UV mutations: single-base mutations"
...
bBro_bSep_path <- "~/biohazard/data/bathBro_bathSep/mut_bathBro2bathSep_one2one_20240311.tsv"
bBro_bSep_title <- "bathBro-bathSep"
...
plotMutationPercentage(bBro_bSep_path, bBro_bSep_title)
```
