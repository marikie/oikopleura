...
I extracted top 10 splicing signals. The orders of top 10 splicing signals are the same in embryos and matured adults.
...
- the same junction mutiple times (= the number of reads crossing the junction)
- the a-little-bit-shifted junctions as different junctions