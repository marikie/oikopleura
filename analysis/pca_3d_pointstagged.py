...
for i, file_name in enumerate(file_names):
    ...
    ax.text(X_pca[i, 0], X_pca[i, 1], X_pca[i, 2], short_name, 
...
plt.savefig('pca_3d_clustering_result_with_labels.png', dpi=300, bbox_inches='tight')
plt.tight_layout()
plt.show()

# 2 Dimentional Projection（ファイル名付き）
...
plt.tight_layout()
plt.savefig('pca_3d_projections_with_labels.png', dpi=300, bbox_inches='tight')
plt.show()
